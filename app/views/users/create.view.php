<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
       ...
       <div class="input_wrapper n30 padding">
            ...
            <input required type="password" name="Password" maxlength="30">
        </div>
       <div class="input_wrapper n20 padding">
            <label><?= $text_label_CPassword ?></label>
            <input required type="password" name="CPassword" maxlength="30">
        </div>
        <div class="input_wrapper n30 border">
            <label><?= $text_label_Email ?></label>
            <input required type="email" name="Email" id="email" maxlength="40">
        </div>
        ...
        <div class="input_wrapper n20 padding border">
            ...
            <input required type="text" name="PhoneNumber" maxlength="40">
        </div>
        <div class="input_wrapper_other padding n20 select">
            <select required name="GroupId" id="type">
                <option value=""><?= $text_label_GroupId ?></option>
                <?php if (false !== $groups): foreach ($groups as $group):;?>
                    <option value="<?=$group->GroupId?>" class="option"><?=$group->GroupName?></option>
